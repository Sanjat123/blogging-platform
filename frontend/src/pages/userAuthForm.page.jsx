...
const UserAuthForm = ({ type }) => {
    ...
    // New Function for GitHub
    const handleGithubAuth = (e) => {
        e.preventDefault();

        // This URL redirects the user to GitHub's authorization page
            ...
            <section className="h-cover flex items-center justify-center">
                ...
                <form id="authForm" className="w-[80%] max-w-[400px]">
                    <h1 className="text-4xl font-gelasio capitalize text-center mb-24">
                        {type == "sign-in" ? "Welcome back" : "Join us Our Blogs"}
                    </h1>
                    ...
                    {/* New GitHub Button */}
                    <button className="btn-dark flex items-center justify-center gap-4 w-[90%] center mt-4"
